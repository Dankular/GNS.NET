...
| Native TURN/STUN configuration injection and direct-then-relay signaling orchestration | Implemented, integrated, and configuration-tested | The GS-managed Coturn service is deployed and allocation-validated on the build VPS; actual GNS NAT/relay traversal needs two external peers. |
